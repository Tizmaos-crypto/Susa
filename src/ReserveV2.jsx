...
const STR = {
  ko: {
    ...
    intro: {
      ...
      exceptRoom: "단, 지정객실 및 힐리우스는 레이트 체크아웃이 12시까지만 제공됩니다.",
    ...
    cancelInfo: "※ 예약 취소·변경은 수영장 프론트 데스크로 문의해 주세요.",
  },
  en: {
    langBtn: "🌐 한국어",
    ...
    cancelInfo: "※ To cancel or change a reservation, please contact the pool front desk.",
  },
};
          ...
          <div className="rsv-lookup-results">
            {lkResults.length === 0 ? (
              ...
              <>
                ...
                <p className="rsv-cancel-note">{t.cancelInfo}</p>
              </>
            )}
          </div>
        )}
        ...
        <div className="rsv-card rsv-intro">
          ...
          <section className="rsv-notice">
            ...
            <div className="rsv-except-box">
              ...
              <p className="rsv-except-room">{tIntro.exceptRoom}</p>
